...
* The `<format_time_string>` parameter must define the format elements that match how the input string is formatted.
Every element in the input string must have a corresponding element in the format string, and their positions must match.
