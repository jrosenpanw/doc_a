...
* **Functions**: [is_ipv6()](is_ipv6.md), [is_known_private_ipv4()](is_known_private_ipv4.md), [incidr6()](incidr6.md)
* **Datasets**: [ips_test_raw](https://docs-cortex.paloaltonetworks.com/r/Cortex-XQL-Schema-Reference-Guide/Introduction)
