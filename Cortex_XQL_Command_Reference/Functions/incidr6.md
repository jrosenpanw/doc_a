...
* When multiple CIDR ranges are provided in the second parameter (separated by commas), the function applies a logical **OR** operation.
If the IPv6 address matches any of the listed ranges, the function returns `true`.
