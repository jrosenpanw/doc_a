...
* [**XQL JSON Functions Reference**](functions/json_functions_reference.md) – Reference for `json_extract`, `json_extract_scalar`, `json_extract_array`, and `json_extract_scalar_array`.
* [**Stages**](stages/) – Pipeline stages that define query structure and flow.
* [**Browse the reference**](summary.md) – Quick links to the main indexes and section entry points.
